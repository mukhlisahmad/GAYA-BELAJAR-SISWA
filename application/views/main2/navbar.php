...
<div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold">Psikotest</span>
            </a>
        ...
        <ul class="menu-inner py-1">
                ...
                <li class="menu-item">
                    ...
                    <i class="menu-icon tf-icons fa-solid fa-people-group"></i>
                        ...
                        <div data-i18n="Test Gaya Belajar">Test Gaya Belajar</div>
                    </a>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?php echo base_url('C_user/konsultasi') ?>" class="menu-link">

                            <div data-i18n="Mulai Test ">Mulai Test</div>
                            </a>
                        </li>
                    </ul>
                    <ul class="menu-sub">
                        <li class="menu-item">
                            <a href="<?php echo base_url('C_user/hasil_gb') ?>" class="menu-link">
